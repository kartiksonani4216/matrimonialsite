  ...
  <body>
          <div class="content-wrapper" style="background-image: url('../assets/img/login.jpg'); background-size: cover; background-position: top center;">
            <div class="page-header">
              <font color="white" style="font-weight:bold;">Gallery</font> 
          ...
          <footer class="footer">
            <div class="footer-inner-wraper">
              <div class="d-sm-flex justify-content-center justify-content-sm-between">
                <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2021 Bridal For Better Partner</span>
              </div>
            </div>
          </footer>
          <!-- partial -->
