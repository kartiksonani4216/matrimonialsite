...
if(isset($_POST['submit']))
{
    ...
    { 
        ...
        if($n2==1)
        {
            ...
            $q2="UPDATE `user_registration1` SET `hobby`='$hobby',`salary`='$salary',`address`='$address',`state`='$state',`city`='$city' WHERE uid='$uid'";
            if($r2=mysqli_query($conn,$q2))
            {
                ...
                {
                    $msg="<b><u>   ". $uname ."</u></b>". "  More Information Updated SuccesFully....We are Going to Dashboard...";
...
if($r12=mysqli_query($conn,$q12))
{
  ...
  {
    $hobby1=$num12['hobby'];
    $salary1=$num12['salary'];
    $address1=$num12['address'];
    $city1=$num12['city'];
}
}
if(isset($_POST['next']))
{
   header("location:user_edit_profile4.php");
}
?>
      ...
      <div class="col-md-12">
              <div class="card ">
                <div class="card-header card-header-rose card-header-text">
                  <div class="card-text">
                    <h4 class="card-title">More About Yourself</h4>
                  </div>
                </div>
                <div class="card-body ">
                  <form method="post"  class="form-horizontal">
                    <div class="row">
                      <label class="col-sm-2 col-form-label"><b>Hobby</b></label>
                      <div class="col-sm-10">
                        <div class="form-group">
                          <input type="text" name="hobby"  class="form-control" value="<?php echo $hobby1?>" required>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group">
                          <input type="text" name="salary"  class="form-control" value="<?php echo $salary1?>" required>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group">
                        <select class="selectpicker" name="state"  data-size="7" data-style="btn btn-primary btn-round" title="Single Select" required>
