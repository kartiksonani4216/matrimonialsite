            ...
            <div class="col-md-12">
              <div class="card" style="background-color:white;opacity:0.6;">
                <div class="card-header card-header-rose card-header-icon">
                  ...
                  <h4 class="card-title"><font color="red" size="6"><b>Active User</b></font></h4>
                </div>
                    ...
                    <table class="table" style="background-color:white;" >
                      <thead>
                        <tr>
                          ...
                          <th><font color="black"><b>Dob</b></font></th>
                                  ...
                                  <tr>
                                    ...
                                    <td class="td-actions text-right">
                                      <button type="button"  rel="tooltip" class="btn btn-info">
                                        <i class="material-icons"><a href="admin_fullprofile.php?uid='.$num1['uid'].'"><font color="white">person</font></a></i>
                                      </button>
                                    </td>
                                  </tr>         
                                  </tbody>';
