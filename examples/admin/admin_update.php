...
if(isset($_POST['update']))
{
      $aname=$_POST['aname'];
      $aemail=$_POST['aemail'];
      $q11="update admin_login set aname='$aname',aemail='$aemail' where aid='$pid'";
...
?>
    ...
    <div class="wrapper " style="background-image: url('../../assets/img/login.jpg'); background-size: cover; background-position: top center;">
      ...
      $q1="select * from admin_login where aid='$pid'";
              ...
              <form method="post">
                <div class="card-avatar">
                  <a href="../images/admin/'.$aimg.'" target="blank">
                    <img class="img" src="../images/admin/'.$aimg.'" />
                  </a>
                </div>
                <div class="card-body">
                  <h6 class="card-category text-gray">Bridal / Admin</h6>
                  <div class="form-group">
                  <input type="text" class="form-control" name="aname" placeholder="Enter Admin Name" >
                </div>
                <div class="form-group">
                <input type="text" class="form-control" name="aemail" placeholder="Enter Admin Email" >
                </div>
                  <p>
