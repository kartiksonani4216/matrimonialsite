...
if(isset($_POST['submit']))
{
    ...
    if($r2=mysqli_query($conn,$q1))
    {
        ...
        {
            $msg ="This Email Is Alredy Used";
            if($action == 1)
            {
              header("refresh:3;url=generate_fakeuser1.php?uid=$id");
            }
            if($action == 2)
            {
              header("refresh:3;url=generate_fakeuser2.php?uid=$id");
            }
            if($action == 3)
            {
              header("refresh:3;url=generate_fakeuser3.php?uid=$id");
            }
            if($action == 4)
            {
              header("refresh:3;url=generate_fakeuser4.php?uid=$id");
            }
            if($action == 5)
            {
              header("refresh:3;url=generate_fakeuser5.php?uid=$id");
            }
            if($action == 6)
            {
              header("refresh:3;url=generate_fakeuser6.php?uid=$id");
            }
            if($action == 7)
            {
        ...
        <div class="row">
          <div class="col-md-10 ml-auto mr-auto">
            <div class="card card-signup">
              <h2 class="card-title text-center">Create Fake User</h2>
              <div class="card-body">
                <div class="row">
