...
{
    header("location:admin_change_profile.php");
}
}
else{
            ...
            <div class="col-md-4">
              <div class="card card-profile" style="opacity:0.7;">
                ...
                <div class="card-body">
                  ...
                  <h4 class="card-title"><b>'.$aname.'</b></h4>
                  ...
                  <button type="submit" name="profile"  class="btn btn-rose pull-right">Change Profile</button></p>
