...
if(isset($_POST['view']))
   {
       $vid=$_POST['uid'];
       $q12="insert into visit_profile values('$new','$id','$name','$vid',current_timestamp())";
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-rose card-header-icon">
                  ...
                  <h4 class="card-title"><b>Visiter Of Your Profile</b></h4>
                </div>
                <div class="card-body">
                        ...
                        <tr>
                         ...
                         <?php
                                ...
                                if($r1=mysqli_query($conn,$q1))
                                {
                                    ...
                                    {
                                        $vuid=$num['uid'];
                                        $q2="select * from user_registration1 where uid='$vuid'";
                                if($r2=mysqli_query($conn,$q2))
                                {
                                    while($num1=mysqli_fetch_assoc($r2))
                                    {
                                          ...
                                          <tr>
                                            ...
                                            <input type="hidden" name="uid" value="'.$num1['uid'].'"/>
                                            <button type="submit" name="view" rel="tooltip" class="btn btn-info">
