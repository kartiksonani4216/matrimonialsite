...
if(isset($_POST['submit']))
{
  ...
  move_uploaded_file($temp,"images/album/$file1");
  $q1="INSERT INTO `user_album` (`uid`, `pid`, `img`, `stamp`) VALUES ('$uid', '$mt1', '$file1', current_timestamp())";
...
<!-- Mirrored from demos.creative-tim.com/material-dashboard-pro/examples/forms/wizard.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 May 2021 09:44:33 GMT -->
              ...
              <div class="card card-wizard" data-color="rose" id="wizardProfile">
                <form  method="post" enctype="multipart/form-data">
                  ...
                  <div class="card-header text-center">
                    <h3 class="card-title"><b><font color="black">
                      Add Your Photo</font></b>
                    </h3>
                    <h5 class="card-description"><b>This Is For Your Better  Profile</b></h5>
                  </div>
                  ...
                  <div class="col-md-7 col-sm-4">
                      <h4 class="title"><b><font color="red">Upload Your  Photo</font></b></h4>
                  ...
                  <div class="card-footer">
                    ...
                    <div class="ml-auto">
                      <button type="submit" class="btn btn-rose btn-fill float-right" name="submit">
...
<!-- Mirrored from demos.creative-tim.com/material-dashboard-pro/examples/forms/wizard.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 May 2021 09:44:34 GMT -->
</html>