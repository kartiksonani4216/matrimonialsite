<?php
    ...
    if(isset($_POST['submit']))
    {
       ...
       $q1= "INSERT INTO `success_story` (`uid`,`sid`, `fname`, `mno`, `title`, `story`, `img`, `stamp`) VALUES ('$uid','$mt1','$fname', '$mno', '$topic ', '$story', '$file1', current_timestamp())";
       if($r1=mysqli_query($conn,$q1))
       {
            $msg="Story Added SuccessFully";
            header("refresh:3;url=view_success_story.php");
      }
       else{
         $error="unsuccesfull";
            ...
            <div class="col-md-12">
              <div class="card ">
                <div class="card-header card-header-rose card-header-text">
                  <div class="card-text">
                    <h4 class="card-title">Success Story</h4>
                  </div>
                </div>
                <div class="card-body ">
                  ...
                  <form method="post" class="form-horizontal" enctype="multipart/form-data">
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group">
                          <input type="text" name="uid" class="form-control" disabled required value="<?php echo $uid; ?>"> 
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group">
                          <input type="text" name="fname" class="form-control" disabled required value="<?php echo $fname; ?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="col-sm-10">
                      <div class="form-group">
                        <input type="text" name="mno" class="form-control" disabled required value="<?php echo $mno; ?>">
                      </div>
                    </div>
                  </div>
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group">
                          <input type="text" name="title" class="form-control" required placeholder="Title Of Your Story">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group">
                        <textarea class="form-control" name="story" rows="5" required placeholder="Enter Your Story"></textarea>
                    </div>
                    <div class="col-md-4 col-sm-4">
                      ...
                      <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                        ...
                        <button type="submit" class="btn btn-primary btn-round float-right" name="submit">
