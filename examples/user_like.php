...
<!-- Mirrored from demos.creative-tim.com/material-dashboard-pro/examples/components/notifications.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 May 2021 09:44:31 GMT -->
            ...
            <div class="col-md-10">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title"><b><font color="red">Like Notification</font></b></h4>
                </div>
                <div class="card-body">
                   <?php
                          ...
                          if($r12=mysqli_query($conn,$q12))
                          {
                              while($num12=mysqli_fetch_assoc($r12))
                              {
                                   $vuid=$num12['uid'];
                                   $pid=$num12['pid'];
                                   $q13="select * from user_registration1 where uid='$vuid'";
                                   if($r13=mysqli_query($conn,$q13))
                                   {
                                       while($num13=mysqli_fetch_assoc($r13))
                                       {
                                         $vname=$num13['fname'];
                                       }
                                   }
                                   $q14="select * from user_album where pid='$pid'";
                                  ...
                                  <a href="images/album/'.$img.'" target="blank"> <span data-notify="message">'.$vname.'Like Your Photo.If Your Are Intrested Please Go To The Find Matches And Visit '.$vname.' Profile.You Can Also Chat With '.$vname.'.</span></a>
                                 </div>';
