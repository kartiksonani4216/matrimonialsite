<?php
    ...
    $msg="";
    $error="";
    $q1="select * from user_registration1 where sid='$sid'";
            ...
            <div class="col-md-12">
              <div class="card ">
                ...
                <div class="card-body ">
                  ...
                  <form method="post" class="form-horizontal" action="view_success_story.php" enctype="multipart/form-data">
                    <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group">
                          <input type="text" name="title" class="form-control" disabled required value="<?php echo $title; ?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group">
                        <textarea class="form-control" name="story" rows="5" required disabled><?php   echo $story;?></textarea>
                    </div>
                    ...
                    <i class="material-icons">favorite</i> Go Back
                  </button>
