                ...
                <div class="card-body ">
                  <form method="post"  class="form-horizontal">
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group">
                          <input type="text" name="heducation"  class="form-control" placeholder="Highest Education.." required>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group">
                          <input type="text" name="about"  class="form-control" placeholder="Write Somethng About you.." required>
                        </div>
                      </div>
                    </div>
