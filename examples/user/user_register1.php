...
if(isset($_POST['submit']))
{
    ...
    { 
        ...
        if($n2==1)
        {
            ...
            $q2="UPDATE `user_registration1` SET `dob`='$dob',`religion`='$religion',`mtongue`='$mtongue',`gender`='$gender',`mno`='$mno' WHERE uid='$uid'";
            if($r2=mysqli_query($conn,$q2))
            {
                ...
                if($r5=mysqli_query($conn,$q5));
                {
                    ...
                    header("refresh:2;url=user_register2.php");
                }
              ...
              <div class="card ">
                ...
                <div class="card-body ">
                  <form method="post"  class="form-horizontal">
                    ...
                    <input type="date" name="dob" class="form-control datepicker" Placeholder="Dob" required>
                  </div>
                      </div>
                    </div>
                    <div class="row">
                      <label class="col-sm-2 col-form-label"><b>Religion</b></label>
                      <div class="col-sm-10">
                        <div class="form-group">
                        <select class="selectpicker" name="religion"  data-size="7" data-style="btn btn-primary btn-round" title="Single Select" required>
                            <option disabled selected>Select Religion</option>
                               <option>Hindu</option>
                                ...
                                <option>Buddh</option>
                                <option>Jain</option>
                                <option>Religion Not Stateds</option>
                    ...
                    <div class="row">
                      <label class="col-sm-2 col-form-label"><b>Mother Tongue</b></label>
                      <div class="col-sm-10">
                        <div class="form-group">
                        <select class="selectpicker"  data-size="7" name="mtongue" data-style="btn btn-primary btn-round" title="Single Select" required>
                    ...
                    <div class="row">
                      <label class="col-sm-2 col-form-label label-checkbox"><b>Gender</b></label>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group">
                          <input type="text" name="mno" pattern="{0-9}[10]" class="form-control" placeholder="Mobile Number.." required>
                        </div>
                      </div>
                    </div><br><br>
