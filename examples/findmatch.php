<?php
  ...
  if(isset($_POST['search']))
  {
    ...
    header("location:findmatch.php?search=$search");
  }
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="content-wrapper">
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page"><a href="dashboard.php" style="text-decoration:none">
                            <font color="black">Go Back</font>
                        </a></li>
                </ol>
            </nav>
        </div>
                            ...
                            <div class="col-12">
                                ...
                                <?php 
                                  if(isset($_GET['search']))
                                  {
                                    ...
                                    $q1="select * from user_registration1 where fname='$findname' or cast='$findname' or uid='$findname' and gender!='$gender'";
